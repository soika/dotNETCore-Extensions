...
namespace Microsoft.AspNetCore.Mvc.Razor
{
    ...
    public class MultiTemplateEngine : IRazorViewEngine
    {
            ...
            bool isMainPage)
        {
            ...
            if (factoryResult.ViewDescriptor.ExpirationTokens != null)
            {
            ...
            HashSet<IChangeToken> expirationTokens)
        {
            ...
            {
                var result = _pageFactory.CreateFactory(viewStartPath.BasePath);
                if (result.ViewDescriptor.ExpirationTokens != null)
                {
                ...
                if (result.Success)
                {
                    ...
                    viewStartPages.Insert(0, new ViewLocationCacheItem(result.RazorPageFactory, viewStartPath.BasePath));
                }
            }
